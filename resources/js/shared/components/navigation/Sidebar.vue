...
<template>
  ...
  >
    ...
    <nav class="flex-1 overflow-y-auto py-4 space-y-1 px-2">
      <template v-for="item in coreNav" :key="item.href">
        
        <a  :href="item.href"
          :title="collapsed ? item.label : undefined"
          class="flex items-center rounded-lg transition-colors duration-150 cursor-pointer"
          :class="[
