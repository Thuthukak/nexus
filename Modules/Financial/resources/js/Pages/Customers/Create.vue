    ...
    <form @submit.prevent="submit" class="space-y-6">
      <div class="bg-surface rounded-xl border border-gray-200 dark:border-gray-800 p-6 space-y-4">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
          ...
          <Input v-model="form.vat_number"   label="VAT Number" type="number"   :error="form.errors.vat_number" />
      ...
      <div class="bg-surface rounded-xl border border-gray-200 dark:border-gray-800 p-6 space-y-4">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
          <Input v-model="form.address.line1" label="Street Address" class="sm:col-span-2" :error="form.errors['address.line1']" />
          <Input v-model="form.address.line2" label="Suburb / Unit" class="sm:col-span-2" :error="form.errors['address.line2']" />
          <Input v-model="form.address.city"  label="City" :error="form.errors['address.city']" />
          <Input v-model="form.address.code"  label="Postal Code" type="number" :error="form.errors['address.code']" />
        </div>
      </div>
